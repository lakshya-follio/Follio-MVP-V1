    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-[#F4FBFF] via-white to-[#E9F5FF] text-slate-900">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-6 py-24">
        <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[2.5rem] border border-slate-200/60 bg-gradient-to-br from-cyan-500 via-teal-500 to-indigo-500 p-12 text-white shadow-2xl shadow-cyan-500/20 ring-1 ring-white/20">
          ...
          <div className="grid gap-6">
            <div className="rounded-[2rem] border border-slate-200/60 bg-white/80 p-8 shadow-lg shadow-cyan-500/5 backdrop-blur-md transition hover:border-cyan-200/50 hover:shadow-cyan-500/10">
              <p className="text-xs font-bold uppercase tracking-widest text-cyan-600">Snapshot</p>
