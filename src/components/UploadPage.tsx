    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-[#F4FBFF] via-white to-[#E9F5FF] text-slate-900">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-16 px-6 py-24">
        <section className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl font-bold leading-tight tracking-tight text-slate-900 md:text-5xl">
                Upload your resume to craft your <span className="bg-gradient-to-r from-cyan-500 via-teal-500 to-indigo-500 bg-clip-text text-transparent">Follio presence</span>
              </h1>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="group rounded-3xl border border-slate-200/60 bg-white/60 p-6 shadow-lg shadow-cyan-500/5 backdrop-blur-md transition hover:border-cyan-200/60 hover:bg-white hover:shadow-xl hover:shadow-cyan-500/10">
                <div className="mb-4 inline-flex items-center gap-2.5 rounded-full bg-cyan-100/50 px-3 py-1 text-xs font-bold uppercase tracking-wide text-cyan-700 group-hover:bg-cyan-100">
          ...
          <div className="rounded-[2.5rem] border border-slate-200/60 bg-white/80 p-10 shadow-2xl shadow-cyan-500/10 backdrop-blur-md">
            <div className="mb-8 flex items-center justify-between">
              ...
              <div className="rounded-full bg-cyan-50 px-4 py-1.5 text-xs font-bold uppercase tracking-wide text-cyan-700 ring-1 ring-cyan-100">
                Auto-parse enabled
              </div>
            </div>
            {!uploadedFile ? (
                ...
                <div className="relative z-10 flex flex-col items-center gap-6">
                  <div
                    className={`rounded-2xl p-5 transition-all duration-300 ${dragActive
                        ? 'bg-cyan-100 text-cyan-600 scale-110 shadow-lg shadow-cyan-500/20'
                        : 'bg-slate-100 text-slate-400 group-hover:bg-cyan-50 group-hover:text-cyan-500 group-hover:scale-110'
                      }`}
                  >
                  ...
                  <label className="inline-flex cursor-pointer items-center gap-2.5 rounded-full bg-gradient-to-r from-cyan-500 to-teal-500 px-8 py-3.5 text-sm font-bold text-white shadow-lg shadow-cyan-500/30 transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-cyan-500/40 active:scale-95">
        ...
        <section className="rounded-[2.5rem] border border-slate-200/60 bg-white/80 p-12 shadow-lg shadow-cyan-500/5 backdrop-blur-md">
          <div className="grid gap-10 md:grid-cols-3">
            <div className="space-y-4 text-center md:text-left">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-50 text-cyan-600 shadow-sm ring-1 ring-cyan-100 md:mx-0">
